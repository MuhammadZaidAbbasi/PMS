        ...
        String auth="INSERT INTO authorization VALUES (?,?,?)";
            try (Connection conn = getConnection();
                ...
                try {
                    ...
                    SystemLog.addLog(new SystemLog(role.toUpperCase() + " with ID "+id+" Added"));
                    idField.clear();
                    nameField.clear();
                    emailField.clear();
                    contactField.clear();
                    ...
                    DoctorDashboard.showAlert(Alert.AlertType.ERROR, "Error", "Failed to insert  into Authorization.");
                    exc.printStackTrace();
                }
