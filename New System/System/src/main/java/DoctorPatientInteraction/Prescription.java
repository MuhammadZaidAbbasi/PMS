...
public class Prescription {
    ...
    public Prescription(){this.prescriptionID+= User.generate_id();}
    public Prescription(String patientId,String doctorId,String dosage, String medicineName, String schedule) {
        this();
